...
function renamech(){
    client.guilds.cache.get("789064772712792086").channels.cache.get("799062006878699581").setName("MEMBERS: " + client.guilds.cache.get("789064772712792086").memberCount)
}
